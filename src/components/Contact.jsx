  ...
  return (
    <div name="contact" className="w-full h-screen">
      <div className="flex flex-col justify-center max-w-screen-lg mx-auto h-full">
        ...
        <p className="text-md sm:text-xl p-4 my-2">Ready to take the next step in my career journey, I'm currently seeking full-time opportunities for 2023. If you have something in mind or just want to chat, please don't hesitate to reach out!</p>
